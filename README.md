...
v1.5.1 还修复了停止最后一个主播时的事件顺序竞态，确保迟到的单任务事件不会把“监控已停止”覆盖为运行中状态。

如需回退，可以继续使用 [v1.4.0](https://github.com/washls/douyin-live-monitor/releases/tag/v1.4.0)。v1.5.1 没有修改配置结构，也没有不可逆的数据迁移。
